...
const Report2 = () => {
    ...
    const tableData = [
        ...
        { id: 3, name: "John Doe", type: "HV", duration: "10 mins", date: "2025-04-15", status: "Completed", notes: "N/A" },
        { id: 4, name: "Jane Smith", type: "LV", duration: "8 mins", date: "2025-04-14", status: "Pending", notes: "Follow-up needed" },
